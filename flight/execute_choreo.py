...
if __name__ == "__main__":
    ...
    #     [
    #         # [[60 * np.pi / 180], [0 * np.pi / 180], [0 * np.pi / 180], [0.0], [0.0], [10.0]],
    #         # [[45 * np.pi / 180], [60 * np.pi / 180], [0 * np.pi / 180], [0.0], [0.0], [10.0]],
    #         [
    #             [45 * np.pi / 180],
    #             [0 * np.pi / 180],
    #             [30 * np.pi / 180],
    ...
    # real choreo
    # target_cheoreography = np.asarray([
    #     [[30], [0], [45], [0.0], [0.0], [10.0 * 180 / np.pi]],
    #     [[0], [30], [30], [0.0], [0.0], [10.0 * 180 / np.pi]],
    #     [[-45], [0], [0], [0.0], [0.0], [10.0 * 180 / np.pi]],
    #     [[-60], [-30], [-30], [0.0], [0.0], [10.0 * 180 / np.pi]]
    # #     # [[0], [0], [-90], [0.0], [0.0], [10.0 * 180 / np.pi]],
    # #     # [[45], [45], [0], [0.0], [0.0], [10.0 * 180 / np.pi]],
    # #     # [[0], [0], [0], [0.0], [0.0], [10.0 * 180 / np.pi]],
    # #     # [[30], [0], [0], [0.0], [0.0], [10.0]],
    # #     # [[30], [0], [0], [0.0], [0.0], [10.0]],
    # #     # [[30], [0], [0], [0.0], [0.0], [10.0]],
    # #     # [[30], [0], [0], [0.0], [0.0], [10.0]],
